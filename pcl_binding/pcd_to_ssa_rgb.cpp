...
const char *message[] = {
        "pcd_to_ssa_rgb: converts a set of PointXYZRGB pcd files into a ssa 3d graph file",
        "usaage: pcd_to_ssa_rgb [options] <ssa3d_file>",
        "options:",
        ...
        "example:",
        "pcd_to_ssa_rgb -p alufr_black_mug_raw -n 60 -r 0.001 alufr_black_mug_raw.ssa3d",
        0
};
