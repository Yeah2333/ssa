...
namespace ssa {
    ...
    template<typename EdgeType1, typename EdgeType2, typename EdgeType3>
    void
    LocalRefinement<EdgeType1, EdgeType2, EdgeType3>::apply(
...
#pragma omp parallel for shared(graph) num_threads(params.maxThreads)
    ...
    template<typename EdgeType1, typename EdgeType2, typename EdgeType3>
    void
    LocalRefinement<EdgeType1, EdgeType2, EdgeType3>::refine(EdgeType3 *correspondence,
...
#pragma omp critical
                ...
                std::cerr
                        << "Could not find correspondence edge in edge list of target vertex (to)! Graph might be corrupted!"
                        << std::endl;
            }
        }
    }
