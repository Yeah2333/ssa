...
DataAssociationT<EdgeType1, EdgeType2, EdgeType3>::DataAssociationT(): strategy_(
        DataAssociationT<EdgeType1, EdgeType2, EdgeType3>::KDTREE) {
...
template<typename EdgeType1, typename EdgeType2, typename EdgeType3>
void
DataAssociationT<EdgeType1, EdgeType2, EdgeType3>::apply(
        SparseSurfaceAdjustmentGraphT <EdgeType1, EdgeType2, EdgeType3> &graph, SparseSurfaceAdjustmentParams &params,
        int level = 0) {
    switch (strategy_) {
        case BRUTEFORCE: {
        ...
        for (int i = 0; i < (int) correspondences.size(); ++i) {
            ...
            if (correspondence->query_point && correspondence->cor_point) {
                ...
                if (
                        ...
                        CorrespondenceRejectionT<EdgeType1, EdgeType2, EdgeType3>::isValid(*correspondences[i],
                                                                                           params.nearestNeighbor.maxAngleDifference,
                                                                                           params.nearestNeighbor.maxColorChannelDiff)
                        ) {
        ...
        for (int i = 0; i < (int) correspondences.size(); ++i) {
            ...
            if (correspondence->query_point && correspondence->cor_point) {
                ...
                if (
                    ...
                    g2o::EdgeGICP meas;
                    meas.pos0 = correspondences[i]->query_point->parentVertex()->estimate().inverse() *
                                correspondences[i]->query_point->estimate();
                    meas.normal0 = correspondences[i]->query_point->normal();
                    meas.pos1 = correspondences[i]->cor_point->parentVertex()->estimate().inverse() *
                                correspondences[i]->cor_point->estimate();
...
template<typename EdgeType1, typename EdgeType2, typename EdgeType3>
void
DataAssociationT<EdgeType1, EdgeType2, EdgeType3>::applyBasedOnOverlap(
        SparseSurfaceAdjustmentGraphT <EdgeType1, EdgeType2, EdgeType3> &graph, SparseSurfaceAdjustmentParams &params,
        int level = 0) {
...
DataAssociationT<EdgeType1, EdgeType2, EdgeType3>::overlap(
        SparseSurfaceAdjustmentGraphT <EdgeType1, EdgeType2, EdgeType3> &graph, SparseSurfaceAdjustmentParams &params,
        int level = 0) {
