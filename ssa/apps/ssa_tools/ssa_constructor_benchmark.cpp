...
//   cerr << "deletion of " << n << " HyperGraph::HyperGraphElement objects took " << (get_time() - timing) * 1000 << "  ms." << endl;
    ...
    cerr << "creation of " << n << " HyperGraph::Vertex objects took " << (get_time() - timing) * 1000 << "  ms."
         << endl;
    ...
    cerr << "deletion of " << n << " HyperGraph::Vertex objects took " << (get_time() - timing) * 1000 << "  ms."
         << endl;
    ...
    cerr << "creation of " << n << " ssa::VertexPointXYZCov objects took " << (get_time() - timing) * 1000 << "  ms."
         << endl;
    ...
    cerr << "deletion of " << n << " ssa::VertexPointXYZCov objects took " << (get_time() - timing) * 1000 << "  ms."
         << endl;
...
//   cerr << "deletion of " << n << " ssa::VertexPointXYZCov objects took " << (get_time() - timing) * 1000 << "  ms." << endl;
    ...
    cerr << "vector creation of " << n << " g2o::VertexPointXYZCov objects took " << (get_time() - timing) * 1000
         << "  ms." << endl;
    ...
    cerr << "vector deletion of " << n << " g2o::VertexPointXYZCov objects took " << (get_time() - timing) * 1000
         << "  ms." << endl;
    ...
    cerr << "creation of " << n << " g2o::VertexPointXYZ objects took " << (get_time() - timing) * 1000 << "  ms."
         << endl;
    ...
    cerr << "deletion of " << n << " g2o::VertexPointXYZ objects took " << (get_time() - timing) * 1000 << "  ms."
         << endl;
...
// <EstimateType,  Eigen::aigned_allocator<EstimateType> >
    ...
    cerr << "creation of " << n
         << " std::deque<Eigen::Vector3f, Eigen::aligned_allocator<Eigen::Vector3f> > objects took "
         << (get_time() - timing) * 1000 << "  ms." << endl;
